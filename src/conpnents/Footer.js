...
const Footer = () => {
    return (
        <section className='p-10 relative' style={{ backgroundColor: "#e8f2ff" }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className='absolute top-0 left-0 z-20  '><path fill="#ffff" fill-opacity="1" d="M0,192L34.3,181.3C68.6,171,137,149,206,149.3C274.3,149,343,171,411,202.7C480,235,549,277,617,256C685.7,235,754,149,823,144C891.4,139,960,213,1029,234.7C1097.1,256,1166,224,1234,208C1302.9,192,1371,192,1406,192L1440,192L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path></svg>
